...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Diego Go', email.body)
        self.assertIn('01516712345', email.body)
        self.assertIn('diego.gomes87@gmail.com', email.body)
        self.assertIn('41-995062619', email.body)
...
class SubscriptionSucessesMessage(TestCase):
